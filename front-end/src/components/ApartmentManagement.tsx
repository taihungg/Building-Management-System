...
export function ApartmentManagement() {
    ...
    const fetchApartments = async () => {
        ...
        try {
            ...
            let baseUrl = 'https://building-management-system.fly.dev/api/v1/apartments';
    ...
    const searchResidents = async (keyword: string) => {
        ...
        try {
            ...
            const response = await fetch(`https://building-management-system.fly.dev/api/v1/residents?keyword=${encodeURIComponent(keyword)}`, {
    ...
    const fetchFormDependencies = async () => {
        try {
            ...
            const resOwner = await fetch('https://building-management-system.fly.dev/api/v1/residents', {
                headers: NGROK_HEADERS
            });
            ...
            const resBuild = await fetch(`https://building-management-system.fly.dev/api/v1/buildings/dropdown?keyword=${encodeURIComponent('%')}`, {
                headers: NGROK_HEADERS
            });
    ...
    const handleViewDetail = async (id) => {
        try {
            ...
            const response = await fetch(`https://building-management-system.fly.dev/api/v1/apartments/${id}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
    ...
    const handleCreateApartment = async () => {
        ...
        const createAction = async () => {
            ...
            try {
                ...
                const response = await fetch('https://building-management-system.fly.dev/api/v1/apartments', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
    ...
    const handleUpdateOwner = async () => {
        ...
        const updateAction = async () => {
            ...
            try {
                // Thay đổi sang domain ngrok của chú
                const response = await fetch(`https://building-management-system.fly.dev/api/v1/apartments/${selectedApartment.id}${queryParam}`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
    ...
    const confirmDelete = async () => {
        ...
        const deleteAction = async () => {
            try {
                ...
                const response = await fetch(`https://building-management-system.fly.dev/api/v1/apartments?id=${apartmentToDelete.id}`, {
                    method: 'DELETE',
                    headers: {
                        'Content-Type': 'application/json',
    ...
    const handleAddResident = async () => {
        ...
        const addAction = async () => {
            ...
            try {
                // Thay đổi sang domain ngrok mới của chú
                const response = await fetch(`https://building-management-system.fly.dev/api/v1/apartments/${selectedApartment.id}/residents/add`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
    ...
    const handleRemoveResident = async (residentId, residentName) => {
        ...
        const removeAction = async () => {
            ...
            try {
                // Thay đổi sang domain ngrok mới của chú
                const response = await fetch(`https://building-management-system.fly.dev/api/v1/apartments/${selectedApartment.id}/residents/remove`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
                                ...
                                <div key={apt.id} className="bg-white rounded-2xl p-6 shadow-md border border-gray-200 hover:shadow-xl transition-shadow">
                                    ...
                                    <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                                        <div className="text-right">
                                            <span className={`inline-flex px-3 py-1 rounded-full text-xs font-bold ${(apt.residentNumber && apt.residentNumber > 0) ? 'bg-emerald-100 text-emerald-800' : 'bg-gray-200 text-gray-800'
                                                }`}>
                    ...
                    <div className="flex flex-col h-full">
                        ...
                        <div className="-mx-6 -mt-6 mb-6 bg-gradient-to-r from-blue-600 to-indigo-700 p-6 text-white rounded-t-lg shadow-md relative overflow-hidden">
                            ...
                            <div className="relative z-10 flex justify-between items-start">
                                ...
                                <div className={`px-4 py-2 rounded-full text-sm font-bold backdrop-blur-md border border-white/20 shadow-sm ${(selectedApartment.residents && selectedApartment.residents.length > 0)
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                                ...
                                <div className="md:col-span-5 space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        ...
                                        <div className={`rounded-xl p-4 flex flex-col items-center justify-center text-center shadow-sm border ${selectedApartment.summary?.unpaidBillsCount > 0 ? 'bg-gradient-to-br from-rose-50 to-red-50 border-red-100' : 'bg-gradient-to-br from-emerald-50 to-green-50 border-green-100'
                                            }`}>

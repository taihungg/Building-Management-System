      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            {[
              { time: "2 phút trước", action: "Cư dân A101 đã thanh toán phí dịch vụ tháng 10", type: "payment" },
              { time: "15 phút trước", action: "Thêm cư dân mới tại căn hộ B205", type: "resident" },
              { time: "1 giờ trước", action: "Gửi thông báo bảo trì thang máy đến tất cả cư dân", type: "notification" },
              { time: "2 giờ trước", action: "Cập nhật giá dịch vụ gửi xe", type: "update" },
              { time: "3 giờ trước", action: "Cư dân C308 yêu cầu hỗ trợ kỹ thuật", type: "support" },
            ].map((activity, index) => (

...
public interface ResidentRepository extends JpaRepository<Resident, UUID> {
    ...
    @Query("""
    	    ...
    	    AND (:buildingId IS NULL OR a.floor.building.id = :buildingId)
    	    AND (:floor IS NULL OR a.floor.floorNumber = :floor)
    	    AND (:apartmentIds IS NULL OR a.id IN :apartmentIds)
    	""")

     List<Resident> findActiveResidentsByFilters(
